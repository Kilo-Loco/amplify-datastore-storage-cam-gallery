...
public struct ModelPhotoConditionInput: GraphQLMapConvertible {
  ...
  public init(imageKey: ModelStringInput? = nil, and: [ModelPhotoConditionInput?]? = nil, or: [ModelPhotoConditionInput?]? = nil, not: ModelPhotoConditionInput? = nil) {
...
public struct ModelPhotoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, imageKey: ModelStringInput? = nil, and: [ModelPhotoFilterInput?]? = nil, or: [ModelPhotoFilterInput?]? = nil, not: ModelPhotoFilterInput? = nil) {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreatePhoto: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, imageKey: String, version: Int, deleted: Bool? = nil, lastChangedAt: Int, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Photo", "id": id, "imageKey": imageKey, "_version": version, "_deleted": deleted, "_lastChangedAt": lastChangedAt, "createdAt": createdAt, "updatedAt": updatedAt])
      }
