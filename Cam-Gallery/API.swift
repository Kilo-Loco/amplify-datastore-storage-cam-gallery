...
public struct CreatePhotoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, imagePath: String, version: Int? = nil) {
    graphQLMap = ["id": id, "imagePath": imagePath, "_version": version]
  }
  ...
  public var imagePath: String {
    get {
      return graphQLMap["imagePath"] as! String
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "imagePath")
    }
  }
...
public struct ModelPhotoConditionInput: GraphQLMapConvertible {
  ...
  public init(imagePath: ModelStringInput? = nil, and: [ModelPhotoConditionInput?]? = nil, or: [ModelPhotoConditionInput?]? = nil, not: ModelPhotoConditionInput? = nil) {
    graphQLMap = ["imagePath": imagePath, "and": and, "or": or, "not": not]
  }

  public var imagePath: ModelStringInput? {
    get {
      return graphQLMap["imagePath"] as! ModelStringInput?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "imagePath")
    }
...
public struct UpdatePhotoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, imagePath: String? = nil, version: Int? = nil) {
    graphQLMap = ["id": id, "imagePath": imagePath, "_version": version]
  }
...
public struct ModelPhotoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, imagePath: ModelStringInput? = nil, and: [ModelPhotoFilterInput?]? = nil, or: [ModelPhotoFilterInput?]? = nil, not: ModelPhotoFilterInput? = nil) {
    graphQLMap = ["id": id, "imagePath": imagePath, "and": and, "or": or, "not": not]
  }
...
public final class CreatePhotoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreatePhoto: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, imagePath: String, version: Int, deleted: Bool? = nil, lastChangedAt: Int, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Photo", "id": id, "imagePath": imagePath, "_version": version, "_deleted": deleted, "_lastChangedAt": lastChangedAt, "createdAt": createdAt, "updatedAt": updatedAt])
      }
